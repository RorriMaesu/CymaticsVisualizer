...
geomSel.addEventListener('change', () => mode = geomSel.value);
...
function setup() {
  ...
  noLoop();
  slider.dispatchEvent(new Event('input')); // initialise label
}
...
// draw whenever frequency or mode changes
slider.addEventListener('input', redraw);
geomSel.addEventListener('change', redraw);
